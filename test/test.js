...
describe('leapyear(4)', function(){
  it("return true - leap years should be divisable by 4", function(){
    expect(code.leapYear(4)).to.equal(true);
  });
});

describe('leapyear(4)', function(){
  it("return false - leap years should be divisable by 4", function(){
    expect(code.leapYear(4)).to.equal(false);
  });
});
